...
#DON'T FORGET TO GIVE CREDIT TO ISMAIL BALOCH
...
def main():
	...
	print("\033[96;1m  [J] JOIN fatima zehra \033[92;1m✘\033[91;1m✘")
...
def log_sel():
	...
	if sel == "":
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/ismailbaloch.113"])
		...
		subprocess.check_output(["am", "start", "https://ismailbaloch.113"])
